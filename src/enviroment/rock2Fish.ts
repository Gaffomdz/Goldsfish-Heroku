...
export class Rock2 extends Entity{
    ...
    public fish2 = new coinCreator()
    

    constructor(health: number, modifier: number, position: Vector3,position2: Vector3) {
        super()
        ...
        this.fish2.addComponent(new Transform({
            position: position2,
            scale: new Vector3(0,0,0)
        }))
        ...
        Dash_Wait(() => {
            ...
            Dash_AnimationQueue.add({
                ...
                onComplete: () => {
                    ...
                    engine.addEntity(this.fish2)
                    this.fish.scalarTest()
                    this.fish2.scalarTest()
