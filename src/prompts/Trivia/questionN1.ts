...
import { questionN2 } from './questionN2'
...
export let questionN1 = new ui.CustomPrompt(ui.PromptStyles.DARKLARGE, 600, 380)
questionN1.canvas = new UICanvas()
questionN1.addText(randomQuestion1, 0, 80, Color4.White(), 20)
questionN1.closeIcon.visible = false


let button1 = questionN1.addButton(
    randomAnswer1,
    -120,
    -20,
    () => {
...
let button2 = questionN1.addButton(
    randomAnswer2,
    -120,
    -90,
    () => {
...
let button3 = questionN1.addButton(
    randomAnswer3,
    120,
    -20,
    () => {
...
let button4 = questionN1.addButton(
    correctAnswer1,
    120,
    -90,
    () => {
...
let wrongAnswer = new UIImage(questionN1.canvas, new Texture('images/trivia/wronganswer.png'))
